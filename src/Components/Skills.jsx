        ...
        <div className="mx-auto flex w-[85%] md:w-[85%] lg:w-[90%] flex-col justify-center bg-white rounded-2xl shadow-xl shadow-gray-400/20">
            ...
            <div className=" flex justify-center items-center flex-col md:items-start p-3">
                ...
                <p className='text-center md:text-left text-[18px] tracking-[0.8px] leading-6 text-secondary-400 px-[2px]'>
                  ...
                  Git, Bootstrap, and Tailwind. <span className=' hidden md:block '>
              ...
              <a
                href="#"
                className="rounded-md bg-white px-3.5 py-2.5 text-sm md:text-base lg:text-lg font-semibold text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
              >
                Get started
              </a>
            </div>
