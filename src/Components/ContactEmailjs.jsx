                  ...
                  <form ref={form} onSubmit={sendEmail}>
                      <div className='grid grid-cols-1'>
                        ...
                        <div className='flex flex-col px-3 py-1 items-start'>
                            ...
                            <button type="submit" value={buttonText} className={`${buttonTextEnable} font-bold text-[#ffffffcb] text-center hover:text-black bg-white  bg-opacity-10 hover:opacity-90 hover:bg-white border border-solid rounded-[20px] border-opacity-50 border-white mt-2 py-4 cursor-not-allowed w-full justify-center`} disabled>{buttonText}</button>
                        </div>
                      </div>
                  </form>
              </div>
