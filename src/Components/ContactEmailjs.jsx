...
export function ContactEmailjs() {
    ...
    return (
      <section className='flex justify-center items-center w-full'>
        <div className='w-full flex justify-center items-center pt-1 pb-8 md:pb-12 px-4 sm:px-8 md:px-10 lg:px-24'>
        ...
        {/* form */}
            <div className=' relative flex w-full min-h-[300px] justify-center' id='contact'>
              <div className=' absolute md:relative top-16 sm:top-4 md:top-0 rounded-3xl flex flex-col justify-center items-center md:items-end bg-primary-100 w-[90%] pt-4 sm:pt-6 pb-6 sm:pb-8 px-1 md:px-3 lg:px-6'>
                  ...
                  <form ref={form} onSubmit={sendEmail}>
                      <div className='grid grid-cols-1'>
                        ...
                        <div className='flex flex-col px-3 py-1'>
                            ...
                            <input type="submit" value={buttonText} className={`${buttonTextDesable} font-bold text-[#ffffffcb] text-center hover:text-black bg-white  bg-opacity-40 hover:opacity-90 hover:bg-white border border-solid border-opacity-50 border-white mt-2 ml-1 py-2 cursor-pointer w-[30%] `} onClick={()=>setButtonText("Sending...")}/>
